...
export const addDataFromSourceDBToWarehouse = () => {
    return (dispatch, getState) => {
        ...
        let request_sdb1 = 'http://localhost:3001/travel';
        let request_sdb2 = 'http://localhost:3002/travel';
        let request_warehouse = 'http://localhost:3003/warehouse/add'
        let travelList;
...
export const deleteDataFromWarehouse = () => {
    return (dispatch, getState) => {
        ...
        let request_warehouse = 'http://localhost:3003/warehouse/delete'
...
export const getCityList = (query) => {
    return (dispatch, getState) => {
        ...
        let request_warehouse = 'http://localhost:3003/warehouse/cityList';
